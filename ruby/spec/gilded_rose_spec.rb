  ...
  describe '#update' do
    ...
    describe 'regular items' do
      it 'decreases quality by 1, decreases sell in by 1 when sell in 0 or more' do
        item1 = ItemDummy.new('+5 Dexterity Vest', 10, 20)
      ...
      it 'decreases quality by 2, decreases sell in by 1 when sell in less than 0' do
        item1 = ItemDummy.new('+5 Dexterity Vest', -1, 20)
        inn1 = GildedRose.new([item1])
        inn1.update
    ...
    describe 'brie' do
      it 'increases quality by 1, decreases sell in by 1 ' do
        item2 = ItemDummy.new('Aged Brie', 2, 0)
      ...
      it 'quality of an item never exceeds 50, except sulfuras' do
        item2 = ItemDummy.new('Aged Brie', 2, 50)
        inn1 = GildedRose.new([item2])
        inn1.update
        expect(item2.sell_in).to eq(1)
    ...
    describe 'sulfuras' do
      it 'keeps quality the same, keeps sell in the same' do
        item4 = ItemDummy.new('Sulfuras, Hand of Ragnaros', 0, 80)
    ...
    describe 'backstage passes' do
      it 'increases quality by 1, decreases sell in by 1' do
        item6 = ItemDummy.new('Backstage passes to a TAFKAL80ETC concert', 15, 20)
      ...
      it 'quality drops to 0 when sell in less than 0' do
        item6 = ItemDummy.new('Backstage passes to a TAFKAL80ETC concert', 0, 50)
        inn1 = GildedRose.new([item6])
        inn1.update
    ...
    describe 'conjured items' do
      it 'reduces quality by 2, decreases sell in by 1 when sell in 0 or more' do
        item9 = ItemDummy.new('Conjured Mana Cake', 3, 6)
      ...
      it 'reduces quality by 4, decreases sell in by 1 when sell in less than 0' do
        item9 = ItemDummy.new('Conjured Mana Cake', 0, 6)
        inn1 = GildedRose.new([item9])
        inn1.update
